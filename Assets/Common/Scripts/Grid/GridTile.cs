...
namespace Common.Grid
{
    ...
    public abstract class GridTile<TPosition, TContext, TOwnType> where TOwnType : GridTile<TPosition, TContext, TOwnType>
    {
        ...
        /// <returns></returns>
        public abstract float GetCost(IGridControl<TPosition, TContext, TOwnType> i_Grid, GridPathElement<TPosition, TContext, TOwnType> i_Source, TContext i_Context, out int o_AvoidanceLevel);
    }
}
